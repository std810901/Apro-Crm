          ...
          <template #content>
            <div class="position-relative">
              ...
              <BlockUI :blocked="loading">
                ...
                >
                  <template #header>
                    <Button icon="pi pi-arrow-left" label="返回" class="p-button-text float-start me-3" @click="$router.go(-1)" />
  ...
  data () {
    return {
      ...
      form: {
        ...
        id: null,
        language: 'tw',
        option_category: this.$route.params.id
      },
      loading: false,
      logLoading: false,
      totalRecords: 0
