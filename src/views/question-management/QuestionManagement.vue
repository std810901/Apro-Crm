            ...
            <div class="position-relative">
              ...
              <BlockUI :blocked="loading">
                ...
                >
                  ...
                  <Column field="title" header="題目"></Column>
                  <Column
                    field="option_category"
                    header="標籤分類"
                  ></Column>
                  <Column field="purposeLabel" header="功能" :sortable="true">
                  </Column>
                  <Column field="option" header="標籤">
                    <template #body="slotProps">
                      <span
                        v-for="(item, index) of slotProps.data.option"
                        :key="index"
  ...
  methods: {
      ...
      questionApi
        ...
        .then(res => {
          ...
          this.questions.forEach(each => {
            ...
            switch (each.purpose) {
              case 0:
                Object.assign(each, { purposeLabel: '市調' })
                break
              case 1:
                Object.assign(each, { purposeLabel: '匹配' })
                break
              default:
                Object.assign(each, { purposeLabel: '' })
                break
            }
          })
        })
    ...
    getMenuList () {
      questionApi
        ...
        .then(res => {
          this.apiHandle(res, false)
          this.optionCategory = res.data.map(m => {
            return {
              id: m.id,
              title: m.title
            }
